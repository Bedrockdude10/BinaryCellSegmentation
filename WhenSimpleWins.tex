...
Table~\ref{tab:monuseg_results} shows MoNuSeg test results (14 images, per-image averaged Dice), answering Q3. VGG reaches Dice~0.794~$\pm$~0.011, statistically indistinguishable from MedT's
published 0.796, and outperforms pretrained Swin by 3.6~points (0.758~$\pm$~0.007;
